...
class _AuthApiService implements AuthApiService {
  ...
  Future<HttpResponse<ResponseModel<UserTokenModel>>> login(
    ...
    _data.addAll(body);
    final _options =
        _setStreamType<HttpResponse<ResponseModel<UserTokenModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ResponseModel<UserTokenModel> _value;
    try {
      _value = ResponseModel<UserTokenModel>.fromJson(
        _result.data!,
  ...
  Future<HttpResponse<ResponseModel<UserModel>>> register(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResponseModel<UserModel> _value;
    try {
      _value = ResponseModel<UserModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<HttpResponse<ResponseModel<dynamic>>> resendOTP(
      {required Map<String, dynamic> body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<ResponseModel<dynamic>>> resetPassword(
      {required Map<String, dynamic> body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<ResponseModel<dynamic>>> completeReset({
  ...
  @override
  Future<HttpResponse<ResponseModel<UserModel>>> getUserDetails() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
